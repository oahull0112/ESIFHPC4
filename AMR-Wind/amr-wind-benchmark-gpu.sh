...
BENCHMARK_DIR=/scratch/${USER}/amr-wind-benchmark/amr-wind-benchmark-gpu
...
# Build AMR-Wind
bash build-amr-wind-benchmark-gpu.sh

# Submit run script
sbatch -J amr-wind-benchmark-gpu-1 -N 1 run-amr-wind-benchmark-gpu.sh; for i in {1..5}; do sbatch -J amr-wind-benchmark-gpu-$((2**i)) -N $((2**i)) run-amr-wind-benchmark-gpu.sh; done
