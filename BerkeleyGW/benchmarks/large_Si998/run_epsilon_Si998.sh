...
#stripe_large.sh BGW_EPSILON_$SLURM_JOBID
cd    BGW_EPSILON_$SLURM_JOBID
ln -s $BGW_DIR/epsilon.cplx.x .
ln -s  ../epsilon.inp .
ln -sfn  ${Si998_WFN_folder}/WFNq.h5      .
ln -sfn  ${Si998_WFN_folder}/WFN_out.h5   ./WFN.h5
...
srun -n 256 -c 32 --cpu-bind=cores ./epsilon.cplx.x
